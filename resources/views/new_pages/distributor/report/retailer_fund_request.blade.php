...
@section('title', 'Retailer Fund Request')
...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Retailer Fund Request</h4>
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" 
                            ...
                            data-sortable="true" 
                            data-url="{{ route('retailer_fund_request_data_distributor') }}" 
            ...
            $('#filterBtn').on('click', function() {
                ...
                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('retailer_fund_request_data_distributor') }}?start_date=' + startDate + '&end_date=' + endDate,
                        silent: true
                    });
                } else {
