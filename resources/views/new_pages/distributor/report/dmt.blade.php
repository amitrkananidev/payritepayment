                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                <select class="js-example-basic-single w-100" id="dmt_id" name="dmt_id" required="">
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" 
                            ...
                            data-sortable="true" 
                            data-url="{{ route('dmt_report_data_distributor') }}" 
...
<script>
        $(function() {
            ...
            $('#filterBtn').on('click', function() {
                ...
                var dmt_id = $('#dmt_id').val();

                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('dmt_report_data_distributor') }}?start_date=' + startDate + '&end_date=' + endDate + '&dmt_id=' + dmt_id,
                        silent: true
                    });
                } else {
