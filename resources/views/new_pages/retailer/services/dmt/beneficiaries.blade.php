...
@section('title', 'Vendor Payment Beneficiaries')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
                <div class="card bg-inner-page">
                  <div class="card-body">
                    <h4 class="card-title text-white">Vendor Payment Beneficiaries</h4>
                    ...
                    <form class="forms-sample" action="{{ route('post_dmt_transaction_retailer') }}" id="dmt_form" method="post">
                        @csrf
                      ...
                      <div class="form-group row">
                          <div class="col-md-9 col-sm-12">
                           ...
                           <select class="js-example-basic-single w-100 form-control" id="beneficiaries" name="beneficiaries" onchange="letsPay()" required="">
                               ...
                               @foreach($data as $r)
                                <option value="{{ $r->id }}">{{ $r->account_holder_name }} | {{ $r->account_number }} | {{ $r->ifsc }} | {{ $r->mobile }}</option>
                               @endforeach
                           </select>
