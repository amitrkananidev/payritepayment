                ...
                <div class="card bg-inner-page">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('ace_post_dmt_transaction_otp_retailer') }}" id="dmt_form" method="post">
                      ...
                      <input type="hidden" name="OTPReferenceID[]" id="OTPReferenceID{{ $k }}" value="{{ $r->otp_reference }}">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <div class="form-check">
                            <input type="text" class="form-control" name="otp[]" id="otp{{ $k }}" minlength="6" placeholder="OTP" aria-label="OTP" required="">
                             </div>
                        </div>
                        
                    </div>
                    <?php $totalamount = $r->amount + $totalamount;  $transafer_type = $r->transfer_type;?>
                    @endforeach
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="form-check">
                            <button type="button" class="button btn btn-primary" onclick="confirmBox()" style="width: 100%;"><span>Pay</span></button>
                             </div>
                        </div>
                    </div>
                    </form>
...
<script>
    ...
    function confirmBox(){
        ...
        var transafer_type = "{{ $transafer_type }}";
