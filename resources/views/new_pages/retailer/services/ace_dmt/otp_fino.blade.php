        ...
        <div class="col-md-12 grid-margin stretch-card">
                <div class="card bg-inner-page">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" id="scandata" action="{{ route('ace_post_dmt_create_customer_verify_retailer') }}" method="post">
                        @csrf
                        ...
                        <input type="hidden" value="{{ $pincode }}" id="pincode" name="pincode">
                        <input type="hidden" value="{{ $aadhar }}" id="aadhar" name="aadhar">
                        <input type="hidden" value="{{ $decode->data->OTPRequestID }}" id="OTPRequestID" name="OTPRequestID">
                        <input type="hidden" value="{{ $decode->data->KYCRequestID }}" id="KYCRequestID" name="KYCRequestID">
