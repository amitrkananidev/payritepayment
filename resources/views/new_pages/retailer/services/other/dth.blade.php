    ...
    <div class="row">
        <div class="col-md-3 grid-margin stretch-card">
                <div class="card bg-inner-page">
                  <div class="card-body">
                    <h4 class="card-title text-white">DTH</h4>
                    ...
                    <form class="forms-sample" action="{{ route('post_recharge_retailer') }}" id="recharge_form" method="post">
                      ...
                      <div class="form-group">
                       ...
                       <select class="js-example-basic-singlea w-100" id="op_code" name="op_code" required="" onchange="getplans()">
                      ...
                      <div class="form-group">
                        <label for="name" class="text-white">Customer ID</label>
                        <input type="text" class="form-control" name="mobile" id="mobile" placeholder="CUSTOMER ID" value="" required="">
                      </div>
                      
                      <div class="form-group">
                        <label for="name" class="text-white">Customer Mobile</label>
                        <input type="text" class="form-control" name="cust_mobile" id="cust_mobile" placeholder="CUSTOMER MOBILE" value="" required="">
                      </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table-offer"
                          ...
                          <thead>
                            <tr>
                                <th data-field="rs" data-formatter="durationFormatter">Duration</th>
                              <th data-field="rs" data-formatter="priceFormatter">Price (Rs)</th>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" 
                            ...
                            data-toggle="table"
                            data-sortable="true" 
                            data-url="{{ route('recharge_dth_report_data_last_retailer') }}">
                        <thead>
                          <tr>
...
<script>
    ...
    // Formatter for extracting the duration key (e.g., "1 MONTHS")
    ...
    // Formatter for extracting the price value (e.g., "150")
...
getLocationUsingGoogleAPI();
    ...
    function getplans(){
        ...
        $('#table-offer').bootstrapTable('refresh', {
            url: 'https://user.payritepayment.in/api/v1/mplan/dth?op='+op,
            silent: false
        });
    }
        $(function() {
            ...
            $('#table-offer').on('click-row.bs.table', function(e, row, $element) {
                ...
                $('#amount').val(priceFormatter(firstColumnValue));
              });
        });
</script>
@endsection
