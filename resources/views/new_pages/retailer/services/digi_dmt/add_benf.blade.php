                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" value="{{ $dmt_token }}" id="dmt_token_add" name="dmt_token_add">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-3 col-sm-12">
                                  <button class="btn btn-primary" id="acc_verify_button" type="button" onclick="verifyBenf()" style="height: 44px;">
                                    Verify
                                  </button>
                              </div>
                          </div>
                          ...
                          <div class="form-group add_benf_bank_drop">
                           ...
                           <select class="js-example-basic-single-bank w-100" id="banks" name="banks" required="">
                               ...
                               @foreach($banks as $r)
                                <option value="{{ $r->name }}" data-ifsc="{{ $r->ifsc }}">{{ $r->name }}</option>
                               @endforeach
                           </select>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="benf_mobile" id="benf_mobile" placeholder="Mobile" value="{{ old('benf_mobile') }}" required="">
                          </div>
                          
                          <div class="button-container">
                            <button type="button" class="button btn btn-primary" onclick="addBenf()"><span>Submit</span></button>
                          </div>
                        </form>
                      </div>
                    </div>
