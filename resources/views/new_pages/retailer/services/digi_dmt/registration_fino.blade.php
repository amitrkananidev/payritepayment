    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
                <div class="card bg-inner-page">
                  <div class="card-body">
                    <h4 class="card-title text-white">DIGIKHATA Login</h4>
                    <!--<p class="card-description"> Bordered layout </p>-->
                    <form class="forms-sample" id="scandata" action="{{ route('bill_post_dmt_create_customer_retailer') }}" method="post">
                        @csrf
                      ...
                      <div class="form-group">
                        <label for="name" class="text-white">AADHAR NO.</label>
                        <input type="text" class="form-control" name="aadhar" id="aadhar" placeholder="AADHAR NO" value="" required="">
                      </div>
                      
                      <b>One Time Customers Kyc Registration Fees Rs.10 will be debited from your ledger.</b>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CaptureAvdm() {
            ...
            var XML = " <PidOptions ver='1.0'> <Opts fCount='1' fType='2' iCount='0' iType='0' indicatorforUID='0' pCount='0' pType='0' format='0' pidVer='2.0' env='P' timeout='10000' otp='' wadh='18f4CEiXeXcfGXvgWA/blxD+w2pw7hfQPY45JMytkPw=' posh='UNKNOWN'/> </PidOptions>";
            var verb = "CAPTURE";
            var err = "";
        ...
        //   var PIDOPTS=' <PidOptions ver="1.0"> <Opts fCount="1" fType="2" pCount="0" iCount="0" pgCount="2" format="0" pidVer="2.0" timeout="10000" pTimeout="20000" posh="UNKNOWN"/> </PidOptions>';
           var XML = ' <PidOptions ver="1.0"> <Opts fCount="1" fType="2" iCount="0" pCount="0" pgCount="2" format="0" iType="0" indicatorforUID="0" pType="0" pidVer="2.0" timeout="10000" pTimeout="20000" posh="UNKNOWN" env="P" otp="" wadh="18f4CEiXeXcfGXvgWA/blxD+w2pw7hfQPY45JMytkPw=" /> </PidOptions>';
           /*
           format=\"0\"     --> XML
           format=\"1\"     --> Protobuf
           */
        ...
        function Capture2() {
            ...
            var PIDOPTS = ' <PidOptions ver="1.0"> <Opts fCount="1" fType="2" iCount="0" pCount="0" pgCount="2" format="0" iType="0" indicatorforUID="0" pType="0" pidVer="2.0" timeout="10000" pTimeout="20000" posh="UNKNOWN" env="P" otp="" wadh="18f4CEiXeXcfGXvgWA/blxD+w2pw7hfQPY45JMytkPw=" /> </PidOptions>';
