        ...
        <div class="col-md-12 grid-margin stretch-card">
                <div class="card bg-inner-page">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" id="scandata" action="{{ route('digi_post_dmt_login_otp_retailer') }}" method="post">
                        @csrf
                        
                      
                      <input type="hidden" name="mobile" id="mobile" value="{{ $customer_mobile }}" >
                      <input type="hidden" name="otp_token" id="otp_token" value="{{ $otp_token }}" >
