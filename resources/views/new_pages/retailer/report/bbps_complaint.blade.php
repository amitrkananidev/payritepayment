...
<div class="content-wrapper">
    ...
    top: 0;"/>
                  <div class="card-body">
                    <h4 class="card-title">Complaint Raise</h4>
                    <!--<p class="card-description"> Add class <code>.table-hover</code>-->
                    </p>
                    <div class="row mb-3">
                            <div class="col-md-3">
                                <label for="name" class="text-black">Mobile Number</label>
                                <input type="text" id="startDate" class="form-control" placeholder="Mobile Number">
                            </div>
                            <div class="col-md-3">
                                <label for="name" class="text-black">Type Od Complaint</label>
                                <input type="text" id="endDate" class="form-control" placeholder="End Date" readonly value="Service">
                            </div>
                            <div class="col-md-3">
                                <label for="name" class="text-black">Participant Type</label>
                            ...
                            <div class="col-md-3">
                                <label for="name" class="text-black">Service Reason</label>
                                <select class="js-example-basic-single w-100" id="dmt_typea" name="dmt_typea" required="">
                                   <option value="0">Select Service Reason</option>
                                   <option value="1">DMT 2</option>
                                   <option value="3">DMT 3</option>
                                   <option value="4">DIGIKHATA</option>
                                </select>
                            ...
                            <div class="col-md-3">
                                <label for="name" class="text-black">Detail</label>
                                <input type="text" id="endDate" class="form-control" placeholder="Detail" readonly value="Service">
                            </div>
                            <div class="col-md-12">
