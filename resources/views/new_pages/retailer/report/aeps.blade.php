                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" data-pagination="true" 
                                ...
                                data-url="{{ route('aeps_report_data_retailer') }}" >
                        <thead>
                          <tr>
                            <th data-field="transaction_id">Trasnaction Id</th>
                            <th data-field="amount">Amount</th>
                            <th data-field="name">Bank</th>
                            <th data-field="transfer_type" data-formatter="evenColunm">Type</th>
            ...
            $('#filterBtn').on('click', function() {
                ...
                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('aeps_report_data_retailer') }}?start_date=' + startDate + '&end_date=' + endDate,
                        silent: true
                    });
                } else {
