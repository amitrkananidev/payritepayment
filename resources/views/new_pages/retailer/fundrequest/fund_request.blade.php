                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" data-pagination="true" 
                                ...
                                data-sortable="true" 
                                data-export-options='{"fileName": "FundRequest", "ignoreColumn": ["operate"], "exportDataType": "all"}'
                                data-export-data-type="all"
                                data-url="{{ route('fund_request_data_retailer') }}" >
                        <thead>
                          <tr>
            ...
            $('#filterBtn').on('click', function() {
                ...
                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('fund_request_data_retailer') }}?start_date=' + startDate + '&end_date=' + endDate,
                        silent: true
                    });
                } else {
