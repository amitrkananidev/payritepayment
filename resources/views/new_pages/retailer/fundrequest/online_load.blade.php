                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" 
                            ...
                            data-sortable="true" 
                            data-url="{{ route('online_fund_data_retailer') }}" 
                            data-export-data-type="all"
                            data-export-options='{"fileName": "online_fund_data_retailer", "ignoreColumn": ["operate"], "exportDataType": "all"}' >
                        <thead>
                          <tr>
            ...
            $('#filterBtn').on('click', function() {
                ...
                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('online_fund_data_retailer') }}?start_date=' + startDate + '&end_date=' + endDate,
                        silent: true
                    });
                } else {
