                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" data-pagination="true" 
                                ...
                                data-url="{{ route('recharge_report_data') }}" >
                        <thead>
                          <tr>
                            ...
                            <th data-field="shop_name">Retailer Shop</th>
                            <th data-field="transaction_id">Trasnaction Id</th>
                            <th data-field="event">Type</th>
                            <th data-field="amount">Amount</th>
                            <th data-field="mobile">Mobile</th>
                            <th data-field="op_name" >Network</th>
                            <th data-field="referenceId" >Network ID</th>
            ...
            $('#filterBtn').on('click', function() {
                ...
                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('recharge_report_data') }}?start_date=' + startDate + '&end_date=' + endDate,
                        silent: true
                    });
                } else {
