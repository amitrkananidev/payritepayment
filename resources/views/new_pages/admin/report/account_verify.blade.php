...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Account Verification report</h4>
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" 
                            ...
                            data-sortable="true" 
                            data-url="{{ route('account_verify_data') }}" 
                            data-export-data-type="all"
                            data-export-options='{"fileName": "Account_Verification", "ignoreColumn": ["operate"], "exportDataType": "all"}'>
                        <thead>
                          <tr>
            ...
            $('#filterBtn').on('click', function() {
                ...
                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('account_verify_data') }}?start_date=' + startDate + '&end_date=' + endDate + '&users=' + users,
                        silent: true
                    });
                } else {
