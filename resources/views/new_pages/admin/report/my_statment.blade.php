                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <a href="https://user.payritepayment.in/report/user-statment-data-export/{{ $mobile }}?" id="exportBtn" class="btn btn-success">Export CSV</a>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                      <table id="table" data-pagination="true"
                                        ...
                                        data-locale="en-US"
                                        data-toggle="table"
                                        data-url="{{ route('usser_statment_data', ['id' => $mobile]) }}"
                                        data-export-types="['csv', 'excel', 'pdf']" 
                                        data-show-export="true" 
                                        data-export-data-type="all"
                                        data-export-options='{"fileName": "my_statment", "exportDataType": "all"}'>
                        <thead>
                          <tr>
                            ...
                            <th data-field="balance">Closing Balance</th>
...
<script>
        $(function() {
            ...
            $('#filterBtn').on('click', function() {
                ...
                var url = 'https://user.payritepayment.in/report/user-statment-data-export/{{ $mobile }}?start_date=' + startDate + '&end_date=' + endDate;
                $("#exportBtn").attr('href',url);

                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('usser_statment_data', ['id' => $mobile]) }}?start_date=' + startDate + '&end_date=' + endDate,
                        silent: true
                    });
                } else {
