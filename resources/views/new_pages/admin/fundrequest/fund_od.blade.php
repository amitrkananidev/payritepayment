                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="table" data-search="true" 
                                        ...
                                        data-export-options='{"fileName": "OD_report", "ignoreColumn": ["operate"], "exportDataType": "all"}'
                                        data-url="{{ route('fund_od_report_data') }}" >
                        <thead>
                          <tr>
            ...
            $('#filterBtn').on('click', function() {
                ...
                if (startDate && endDate) {
                    $('#table').bootstrapTable('refresh', {
                        url: '{{ route('fund_od_report_data') }}?start_date=' + startDate + '&end_date=' + endDate,
                        silent: true
                    });
                } else {
